...
<div className={theme}>
            <nav className="navbar   d-flex justify-content-around">
                <div className="container-fluid" >
                    <a className="navbar-brand" id={theme} style={{fontSize:"35px"}} href="#">Navbar scroll</a>
                    ...
                    <div>
                        ...
                        <form className="d-flex justify-content-around" role="search">
                            ...
                            <button style={{padding:"0px 20px"}} className="btn btn-outline-success" type="submit">Login</button>
                            <button  style={{padding:"0px 20px" , margin:"0px 25px"}} className="btn btn-outline-success" type="submit">Contect</button>
